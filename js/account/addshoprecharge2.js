...
$(".otherPayBlock .chooseBlock").on("click", function() {
	if(otherNoChoose) { //选中
		...
		//		添加支付宝支付链接
		document.querySelector(".operateBlock .nextStap").innerHTML = '<a href="https://app.fanbaoyundian.com/apiapiextend/apib/Nativenotify/code?uid=' + userinfo.uid + '&token=' + userinfo.token + '&money=0.01&body='+id+'" style="color:#333;" target="_blank">去支付</a>';
